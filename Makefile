...
LFLAGS=-s
OBJD = obj
OBJ = $(OBJD)/bfk.o $(OBJD)/CVanillaState.o $(OBJD)/CExtendedState.o $(OBJD)/CExtended2State.o $(OBJD)/CExtended3State.o
SRCD = source
...
$(OBJD)/bfk.o: $(SRCD)/IBasicState.h $(SRCD)/CVanillaState.h $(SRCD)/CExtendedState.h $(SRCD)/CExtended2State.h $(SRCD)/CExtended3State.h $(SRCD)/bfk.cpp
